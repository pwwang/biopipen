...
pMutSig = proc_factory(
    ...
    args=Diot(
        cvrg=params.mutsig_cvrg.value,
        cvrt=params.mutsig_cvrt.value,
        mutdict=params.mutsig_mutdict.value,
        chrdir=params.mutsig_chrdir.value,
        mutsig=params.mutsig.value,
        mcr=params.mcr.value,
    )
)
...
pMaf2Vcf = proc_factory(
    ...
    args=Diot(maf2vcf=params.maf2vcf.value,
              ref=params.ref.value,
