...
pVcfAnno = proc_factory(
    ...
    args=Diot(
        ...
        dbs=Diot(snpeff=params.snpeffDb.value,
...
pVcfSplit = proc_factory(
    ...
    args=Diot(
        tool='bcftools',
        bcftools=params.bcftools.value,  # used to extract samples,
        gatk=params.gatk.value,
        tabix=params.tabix.value,
        ref=params.ref.value,  # only for gatk,
        params=Diot(),
        nthread=1,
    )
)
...
pVcfMerge = proc_factory(
    ...
    args=Diot(
        tool='bcftools',
        vcftools=params.vcftools_merge.value,
...
pVcfStats = proc_factory(
    ...
    args=Diot(vcfstats=params.vcfstats.value,
...
pVcfExprAnno = proc_factory(
    ...
    output='outfile:file:{{i.infile | bn}}',
    args=Diot(vcf_expression_annotator=params.vcf_expression_annotator.value,
              bcftools=params.bcftools.value,
              exprtype='',
              params=Diot(),
              istx=False,
