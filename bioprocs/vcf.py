...
def _pVcfAnno():
	...
	@args:
		...
		params          (Box) : Other parameters for the tool.
...
def _pVcfExprAnno():
	...
	@args:
		...
		params (Box): Other parameters for vcf-expression-annotator
...
def _pVcfIndex():
	...
	return Box(
		...
		args = Box(tabix = params.tabix.value, nthread = 1)
	)
...
def _pVcfy():
	...
	@args:
		...
		params   (Box)          : Other parameters for vcfy
