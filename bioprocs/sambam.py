...
pBamMarkdup = proc_factory(
    ...
    args=Diot(
        ...
        sambamba=params.sambamba.value,
        picard=params.picard.value,
        biobambam_bamsort=params.biobambam_bamsort.value,
        samtools=params.samtools.value,
        bamutil=params.bamutil.value,
        rmdup=False,
        tmpdir=params.tmpdir.value,
        nthread=1,
        params=Diot(),
...
pBamRecal = proc_factory(
    ...
    args=Diot(
        ...
        ref=params.ref.value,
        tmpdir=params.tmpdir.value,
        knownSites=params.dbsnp.value,
        nthread=1,
        mem=params.mem32G.value,
    )
)
...
pBam2Gmut = proc_factory(
    ...
    args=Diot(
        ...
        samtools=params.samtools.value,
        platypus=params.platypus.value,
        picard=params.picard.value,
        strelka=params.strelka_germ.value,
...
pBamStats = proc_factory(
    ...
    args=Diot(
        tool='bamstats',
        bamstats=params.bamstats.value,
        params=Diot(),
        mem=params.mem16G.value,
        plot=True,
...
pBam2Counts = proc_factory(
    ...
    args=Diot(
        tool='htseq',
        htseq=params.htseq_count.value,
        params=Diot(),
        refgene=params.refexon.value,
    )
)
