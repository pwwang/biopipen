...
params.tracks.desc = ('The track types. Could be data, anno, '
                      'interaction or ucsc, or multiple of them.')
...
params.splitlen.desc = ('Split the plot into 2 if '
                        'the region is longer then splitlen.')
params.forks = 2
