...
def main():
    ...
    if 'germ' in opts.muts:
        ...
        pBam2Gmut.config.export_dir = path.join(opts.exdir, 'germline')
    if 'soma' in opts.muts:
        ...
        pBamPair2Smut.config.export_dir = path.join(opts.exdir, 'somatic')
    if 'scnv' in opts.muts:
        ...
        aBam2SCNV.config.export_dir = path.join(opts.exdir, 'scnv')
    ...
    if 'gcnv' in opts.muts:
        ...
        aBam2GCNV.config.export_dir = path.join(opts.exdir, 'gcnv')
