...
pBedClosest = proc_factory(
    ...
    args=Diot(bedtools=params.bedtools.value, params=Diot())
)
...
pBedMakewindows = proc_factory(
    ...
    args=Diot(bedtools=params.bedtools.value, params=Diot(), intype='bed')
)
...
pBedGenomecov = proc_factory(
    ...
    args=Diot(bedtools=params.bedtools.value, params=Diot(bg=True)),
)
