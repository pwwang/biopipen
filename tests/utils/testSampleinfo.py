...
class TestSampleInfo(helpers.TestCase):
	...
	def dataProvider_testSampleInfo(self,testdir, indir):
		sfile = path.join(indir, 'sampleinfo1.txt')
	...
	def dataProvider_testSelect(self, testdir, indir):
		sifile = path.join(indir, 'sampleinfo1.txt')
	...
	def dataProvider_testSampleInfoR(self, testdir, indir):
		rfile = path.join(indir, 'sampleinfo.r')
		sfile = path.join(indir, 'sampleinfo1.txt')
