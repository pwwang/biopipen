...
class CellTypeAnnotation(Proc):
    ...
    - Cluster-level tools: annotate the clusters, each cluster being assigned one cell type.
      These include `sctype`, `hitype`, `sccatch`, `scsorter`, `singler`, `gptcelltype`, and `direct`.
    - Cell-level tools: annotate the cells, each cell being assigned one cell type.
      These include `scina`, `cellassign`, `cellid`, `scbert`, `schdeepinsight`, and `cell`.
    ...
    `schdeepinsight_args`, `gptcelltype_args`, `cellassign_db`, `cellassign_args`,
    ...
    Envs:
        tool (choice): The tool to use for cell type annotation.
            ...
            - gptcelltype (cluster-level): Use `GPTCelltype` to annotate cell types
        ...
        gptcelltype (ns): The arguments for
