...
version:
	...
	MERGE_COMMIT=$$(git log --grep="Merge remote-tracking branch 'origin/master' into dev" --grep="Merge branch 'master' into dev" --grep="^[0-9]\+\.[0-9]\+\.[0-9]\+" --pretty=format:"%H" -1 2>/dev/null || echo ""); \
